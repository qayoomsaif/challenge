  ...
  return (
    <View style={styles.container} >
      ...
      <View style={styles.centerBlock}>
        {title ? <Text style={[styles.titleText, titleTextStyle]}>{title}</Text> : null}
        {subDetail ? <Text style={[styles.subDetailText, subDetailTextStyle]}>{subDetail}</Text> : null}
      </View>
      <View style={styles.optionBlockContainer}>
        {option || OptionIcon ? (
          ...
          >
            {OptionIcon ? <OptionIcon /> : <Text style={[styles.optionText, optionTextStyle]}>{option}</Text>}
          </TouchableOpacity>
        ) : null}
      </View>
    </View>
